...
python scripts/sample_refs.py ../data/tobamo/reference_nukleotidne.fasta training 300 30 results/training/sampling/fitted_curve_lens_freq.json

3. pairwise alignment

time python scripts/getorfs_pairwise_aln.py <path/to/contig.fasta> <out_dir_name> <contig_orientation>
